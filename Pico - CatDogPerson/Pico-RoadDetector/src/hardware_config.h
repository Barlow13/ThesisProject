...
#ifndef byte
typedef uint8_t byte;  // Only define if not already defined
#endif
...
#define PIN_MISO        4
#define PIN_CS          16
#define ARDUCAM_SPI_FREQ  (4 * 1000 * 1000)  // 4 MHz
...
#ifdef __cplusplus
// C++ class definition - only visible to C++ files
class ArduCAM 
{
	public:
	ArduCAM( void );
...
#else
// For C files, just forward declare the ArduCAM struct/type
typedef struct ArduCAM ArduCAM;
#endif
...
#endif /* HARDWARE_CONFIG_H - proper header guard closing */